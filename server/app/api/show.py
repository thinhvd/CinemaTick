...
def create_show():
    ...
    print(new_show_date)
    shows = Show.query.filter(Show.room_id == data['room_id'],Show.ticket_cost > 0,Show.schedule >= new_show_date,Show.schedule < new_show_date + datetime.timedelta(days=1))
