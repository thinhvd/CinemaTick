          ...
          <Space className="contact" direction="vertical" style={{}}>
            ...
            >
              ...
              <Paragraph style={{ color: "white" }}>
                <strong>
                  Website đặt vé xem phim được tạo từ năm 2023 bởi 4 bạn sinh
                  viên Vũ Đức Thịnh, Trịnh Quốc Đạt,
                  <br />
                  Nguyễn Lê Minh, Hoàng Vũ Anh. Với mong muốn đạt được điểm A+,
                  4 bạn sinh viên đã nỗ lực <br />
                  ngày qua ngày để làm và hoàn thiện website giúp mọi người đặt
                  và mua vé xem phim dễ dàng
                </strong>
              </Paragraph>
            </Space>
            <Space
          ...
          <Space className="contact" direction="vertical" style={{}}>
            ...
            >
              ...
              <Image
                className="logoweb"
                src={
                  "https://scontent.fhan5-10.fna.fbcdn.net/v/t39.30808-6/276997599_112317424757617_6953049204506381803_n.jpg?_nc_cat=101&ccb=1-7&_nc_sid=783fdb&_nc_ohc=fAjQknKEloAAX_I_vNu&_nc_ht=scontent.fhan5-10.fna&oh=00_AfAfJ2SXm6wyKG5j624zGnVxvnSX1dguypx0k9jE5CGf-A&oe=65965ECA"
                }
              />
              <Paragraph style={{ color: "white" }}>
              ...
              <Image
                className="logoweb"
                src={
                  "https://scontent.fhan5-6.fna.fbcdn.net/v/t39.30808-6/339159584_240898315065344_1570296131210151142_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=efb6e6&_nc_ohc=AgGHPDifAhcAX-QtrXd&_nc_ht=scontent.fhan5-6.fna&oh=00_AfCvz5yX-UVBh6UDk68oW1ttxkJ0oS9nnH8f14xuYkKXXg&oe=6596E152"
                }
              />
            </Space>
          </Space>
